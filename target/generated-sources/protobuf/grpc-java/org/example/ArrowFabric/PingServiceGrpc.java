...
public final class PingServiceGrpc {
  ...
  public static final String SERVICE_NAME = "org.example.ArrowFabric.PingService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<org.example.ArrowFabric.PingRequest,
      org.example.ArrowFabric.PongResponse> getPingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ping",
      requestType = org.example.ArrowFabric.PingRequest.class,
      responseType = org.example.ArrowFabric.PongResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.example.ArrowFabric.PingRequest,
      org.example.ArrowFabric.PongResponse> getPingMethod() {
    io.grpc.MethodDescriptor<org.example.ArrowFabric.PingRequest, org.example.ArrowFabric.PongResponse> getPingMethod;
      ...
      synchronized (PingServiceGrpc.class) {
        if ((getPingMethod = PingServiceGrpc.getPingMethod) == null) {
          PingServiceGrpc.getPingMethod = getPingMethod =
              io.grpc.MethodDescriptor.<org.example.ArrowFabric.PingRequest, org.example.ArrowFabric.PongResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ping"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.ArrowFabric.PingRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.ArrowFabric.PongResponse.getDefaultInstance()))
  ...
  public static abstract class PingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void ping(org.example.ArrowFabric.PingRequest request,
        io.grpc.stub.StreamObserver<org.example.ArrowFabric.PongResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                org.example.ArrowFabric.PingRequest,
                org.example.ArrowFabric.PongResponse>(
                  this, METHODID_PING)))
          .build();
    }
  }
  ...
  public static final class PingServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<PingServiceBlockingStub> {
    ...
    /**
     */
    public org.example.ArrowFabric.PongResponse ping(org.example.ArrowFabric.PingRequest request) {
  ...
  public static final class PingServiceFutureStub extends io.grpc.stub.AbstractFutureStub<PingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.example.ArrowFabric.PongResponse> ping(
        org.example.ArrowFabric.PingRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PING:
          serviceImpl.ping((org.example.ArrowFabric.PingRequest) request,
              (io.grpc.stub.StreamObserver<org.example.ArrowFabric.PongResponse>) responseObserver);
          break;
        default:
