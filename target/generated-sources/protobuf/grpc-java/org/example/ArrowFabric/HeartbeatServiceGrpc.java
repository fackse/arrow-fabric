...
public final class HeartbeatServiceGrpc {
  ...
  public static final String SERVICE_NAME = "org.example.ArrowFabric.HeartbeatService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<org.example.ArrowFabric.Empty,
      org.example.ArrowFabric.ServerStatus> getPingMethod;
  ...
  public static io.grpc.MethodDescriptor<org.example.ArrowFabric.Empty,
      org.example.ArrowFabric.ServerStatus> getPingMethod() {
    io.grpc.MethodDescriptor<org.example.ArrowFabric.Empty, org.example.ArrowFabric.ServerStatus> getPingMethod;
    if ((getPingMethod = HeartbeatServiceGrpc.getPingMethod) == null) {
      synchronized (HeartbeatServiceGrpc.class) {
        if ((getPingMethod = HeartbeatServiceGrpc.getPingMethod) == null) {
          HeartbeatServiceGrpc.getPingMethod = getPingMethod =
              io.grpc.MethodDescriptor.<org.example.ArrowFabric.Empty, org.example.ArrowFabric.ServerStatus>newBuilder()
              ...
              .setSchemaDescriptor(new HeartbeatServiceMethodDescriptorSupplier("ping"))
              .build();
        }
      }
    }
  ...
  public static abstract class HeartbeatServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void ping(org.example.ArrowFabric.Empty request,
  ...
  public static final class HeartbeatServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HeartbeatServiceBlockingStub> {
    ...
    /**
     */
    public org.example.ArrowFabric.ServerStatus ping(org.example.ArrowFabric.Empty request) {
  ...
  public static final class HeartbeatServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HeartbeatServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.example.ArrowFabric.ServerStatus> ping(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PING:
          serviceImpl.ping((org.example.ArrowFabric.Empty) request,
              (io.grpc.stub.StreamObserver<org.example.ArrowFabric.ServerStatus>) responseObserver);
          break;
        default:
